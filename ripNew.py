            ...
            if reached_goal(i, start_positions, goal_positions, radius):
                ...
                for j in range(number_of_uavs):
                    if j != i:  # Ensure we're not calculating TGO with itself
                        tgo = calculate_time_to_go(i, j, velocity_v)
                ...
                if closest_uav is not None and collision(i, closest_uav, start_positions, velocity_v, velocity_u, collision_distance, sensor_range):
                    colliding=True
